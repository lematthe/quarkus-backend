// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties17
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties17#deploy_0
    RETURN
    ** label2
