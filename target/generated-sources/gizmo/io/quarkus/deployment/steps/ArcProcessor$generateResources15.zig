// Class: io/quarkus/deployment/steps/ArcProcessor$generateResources15
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ArcProcessor$generateResources15#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 14
    CHECKCAST java/util/Collection
    LDC (String) "io.quarkus.hibernate.orm.runtime.DefaultEntityManagerProducer"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 14
    ...
    ALOAD 14
    CHECKCAST java/util/Collection
    LDC (String) "javax.persistence.EntityManager"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 14
