// Class: io/quarkus/deployment/steps/HibernateOrmProcessor$startPersistenceUnits19
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/HibernateOrmProcessor$startPersistenceUnits19#deploy_0
    RETURN
    ** label2
