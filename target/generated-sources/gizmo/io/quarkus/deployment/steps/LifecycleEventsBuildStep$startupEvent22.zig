// Class: io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent22
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent22#deploy_0
    RETURN
    ** label2
