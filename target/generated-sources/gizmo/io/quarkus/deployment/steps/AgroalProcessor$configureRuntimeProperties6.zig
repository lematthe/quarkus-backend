// Class: io/quarkus/deployment/steps/AgroalProcessor$configureRuntimeProperties6
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/AgroalProcessor$configureRuntimeProperties6#deploy_0
    RETURN
    ** label2
